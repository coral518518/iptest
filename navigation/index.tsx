...
import SavedIpsScreen from "@/screens/SavedIpsScreen/index";
...
function BottomTabNavigator() {
  ...
  return (
    ...
    >
      ...
      <BottomTab.Screen
        name="SavedIps"
        component={SavedIpsScreen}
        options={({ navigation }: RootTabScreenProps<"SavedIps">) => ({
          title: AppI18n.t("savedIps.title"),
